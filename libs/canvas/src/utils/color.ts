/**
 * convert color name or hex to rgba format
 * @param color
 * @param opacity
 * @returns
 */
export function convertColorToRGBA(color: string, opacity = 1) {
 ...
 * @returns
 */
export function colorNameToHex(name: string) {
  return colors[name.toLowerCase() as keyof typeof colors] ?? null;
}
